...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <div class=\"bc\">\r\n\r\n        <div class=\"w\">\r\n            <!-- <div class=\"banner\">\r\n                <img src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/banner/banner8.jpg\" alt=\"\">\r\n            </div> -->\r\n        </div>\r\n\r\n        <div class=\"w\">\r\n            <div class=\"box\">\r\n                <!--内容栏目-->\r\n                <div class=\"lmy_main\">\r\n                    <div class=\"left\">\r\n                        <!-- <div class=\"l_top\">\r\n                            新闻资讯\r\n                        </div> -->\r\n                        <div class=\"l_bottom\">\r\n                            <ul class=\"ul_f\">\r\n                                ");
	...
	if (Utils.ObjectToStr(model.fields["video_src"])!="")
	{
	...
	templateBuilder.Append("\r\n    <script src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/ckplayer/ckplayer.js\"></");
	templateBuilder.Append("script>\r\n    <script>\r\n        var videoObject = {\r\n            container: '#video-box',//“#”代表容器的ID，“.”或“”代表容器的class\r\n            variable: 'player',//该属性必需设置，值等于下面的new chplayer()的对象\r\n            poster: '");
	templateBuilder.Append(Utils.ObjectToStr(model.img_url));
	templateBuilder.Append("',//封面图片\r\n            video: '" + Utils.ObjectToStr(model.fields["video_src"]) + "'//视频地址\r\n        };\r\n        var player = new ckplayer(videoObject);\r\n    </");
	templateBuilder.Append("script>\r\n    ");
	}	//end for if
