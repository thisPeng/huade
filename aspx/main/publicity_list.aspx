...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    ");
	DataTable publicityList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "publicity_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">");
	templateBuilder.Append(publicityList.Rows[0]["title"].ToString());

	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"clear\"></div>\r\n                        <div class=\"entry\">\r\n                            ");
	templateBuilder.Append(publicityList.Rows[0]["publicity"].ToString());
	...
	templateBuilder.Append(linkurl("publicity_show",Utils.ObjectToStr(dr["id"])));
