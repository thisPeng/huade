...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(linkurl("study_list",Utils.ObjectToStr(drr["id"])));
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    ");
	DataTable studyList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "study_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                    <div class=\"right\">\r\n                        ");
	if (studyList.Rows.Count>0)
	{

	templateBuilder.Append("\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">");
	templateBuilder.Append(studyList.Rows[0]["title"].ToString());

	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"clear\"></div>\r\n                        <div class=\"entry\">\r\n                            ");
	templateBuilder.Append(studyList.Rows[0]["study"].ToString());
	...
	foreach(DataRow dr in studyList.Rows)
	{

	templateBuilder.Append("\r\n                                <li><a title=\"" + Utils.ObjectToStr(dr["title"]) + "\" href='");
	templateBuilder.Append(linkurl("study_show",Utils.ObjectToStr(dr["id"])));
