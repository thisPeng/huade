...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n    <div class=\"bc\">\r\n        <div class=\"w\">\r\n            <!-- <div class=\"banner\">\r\n                <img src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/banner/banner1.jpg\" alt=\"\">\r\n            </div> -->\r\n        </div>\r\n        <div class=\"w\">\r\n            <div class=\"box\">\r\n                <!--内容栏目-->\r\n                <div class=\"lmy_main\">\r\n                    <div class=\"left\">\r\n                        <!-- <div class=\"l_top\">\r\n                            其他服务\r\n                        </div> -->\r\n                        <div class=\"l_bottom\">\r\n                            <ul class=\"ul_f\">\r\n                                ");
	...
	templateBuilder.Append("\">\r\n                                    <p class=\"p_f\">\r\n                                        <a href='");
	templateBuilder.Append(linkurl("service_list",Utils.ObjectToStr(dr["id"])));
	...
	templateBuilder.Append(linkurl("service_list",Utils.ObjectToStr(drr["id"])));
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    ");
	DataTable serviceList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "service_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">");
	templateBuilder.Append(serviceList.Rows[0]["title"].ToString());

	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"clear\"></div>\r\n                        <div class=\"entry\">\r\n                            ");
	templateBuilder.Append(serviceList.Rows[0]["service"].ToString());
	...
	foreach(DataRow dr in serviceList.Rows)
	{

	templateBuilder.Append("\r\n                                <li><a title=\"" + Utils.ObjectToStr(dr["title"]) + "\" href='");
	templateBuilder.Append(linkurl("service_show",Utils.ObjectToStr(dr["id"])));
