...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	base.channel = "bussiness";
	base.OnInit(e);
	StringBuilder templateBuilder = new StringBuilder(220000);

	if (Utils.ObjectToStr(model.fields["d_txt2"])!="")
	{


	if (Utils.ObjectToStr(model.fields["d_txt2"]).Contains(".pdf"))
	{

	templateBuilder.Append("\r\n<script src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/js/pdfobject.js\"></");
	templateBuilder.Append("script>\r\n<script>\r\n    window.onload = function (){\r\n        var myPDF = new PDFObject({ url: \"" + Utils.ObjectToStr(model.fields["d_txt2"]) + "\" }).embed();\r\n    };\r\n</");
	templateBuilder.Append("script>\r\n");
	}
	else
	{
	...
	templateBuilder.Append("" + Utils.ObjectToStr(model.fields["d_txt2"]) + "' width='100%' height='100%' frameborder='1'>\r\n</iframe>\r\n");
	}	//end for if
	...
	templateBuilder.Append("\r\n                                <li class=\"");
	if (Utils.StrToInt(Utils.ObjectToStr(dr["id"]), 0)==model.category_id)
	{
	...
	templateBuilder.Append(linkurl("bussiness_list",Utils.ObjectToStr(drr["id"])));
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"right\">\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"page-info\"><span>");
	templateBuilder.Append(Utils.ObjectToStr(model.add_time));
	templateBuilder.Append("</span><span><script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	...
	templateBuilder.Append("\"></");
	templateBuilder.Append("script>人评论</span><span><script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	...
	templateBuilder.Append("script>次</span></div>\r\n                        <div class=\"metanote\">\r\n                            <p>");
	templateBuilder.Append(Utils.ObjectToStr(model.zhaiyao));
	templateBuilder.Append("</p>\r\n                        </div>\r\n                        <div class=\"clear\"></div>\r\n                        <div class=\"entry\">\r\n                            ");
	templateBuilder.Append(Utils.ObjectToStr(model.content));
	templateBuilder.Append("\r\n                        </div>\r\n                        <div class=\"next-box\">\r\n                            <p class=\"prev\">上一篇：\r\n                                ");
	templateBuilder.Append(get_prevandnext_article("bussiness_show", -1, "没有了", 0).ToString());
