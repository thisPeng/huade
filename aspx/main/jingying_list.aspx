...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    ");
	DataTable contentList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "jingying_list", category_id, "__id__");
	...
	templateBuilder.Append(linkurl("jingying_show",Utils.ObjectToStr(dr["id"])));
	...
	DTcms.Model.article m1 = get_model(8);
