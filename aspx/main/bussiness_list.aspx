...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	if (category_id==15)
	{
	 ...
	 contentList = get_article_list(channel, category_id, pagesize, page, "status=0 and DateDiff(dd,d_txt1,getdate())<=0", out totalcount, out pagelist, "bussiness_list", category_id, "__id__");
	...
	else
	{
	 ...
	 contentList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "bussiness_list", category_id, "__id__");

	templateBuilder.Append("<!--取得一个分页DataTable-->\r\n                    ");
	}	//end for if

	if (model.call_index=="bussiness")
	{
	...
	templateBuilder.Append(linkurl("bussiness_show",Utils.ObjectToStr(dr["id"])));
