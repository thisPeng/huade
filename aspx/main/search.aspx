...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable cnews = get_category_child_list("news", 0);
	...
	DataTable cnews1 = get_category_child_list("news", Utils.StrToInt(Utils.ObjectToStr(dr["id"]), 0));
	...
	templateBuilder.Append("\r\n                                        <li><p><a href='");
	templateBuilder.Append(linkurl("news_list",Utils.ObjectToStr(drr["id"])));
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    <!--取得一个DataTable-->\r\n                    ");
	DataTable list = get_search_list(12, out totalcount);

	 pagelist = get_page_link(12, page, totalcount, linkurl("search","?keyword=" + Server.UrlEncode(keyword) + "&page=__id__"));

	templateBuilder.Append("\r\n                    <div class=\"right\">\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">搜索结果：");
	templateBuilder.Append(Utils.ObjectToStr(keyword));
	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"news-content\">\r\n                            <ul class=\"news-list\">\r\n                                ");
	foreach(DataRow dr in list.Rows)
	{

	templateBuilder.Append("\r\n                                <li><a title=\"" + Utils.ObjectToStr(dr["title"]) + "\" href='" + Utils.ObjectToStr(dr["link_url"]) + "'>" + Utils.ObjectToStr(dr["title"]) + "</a><span>");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(dr["add_time"])).ToString("yyyy-MM-dd"));
