...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\">\r\n                                    <p class=\"p_f\">\r\n                                        <a href='");
	templateBuilder.Append(linkurl("content_list",Utils.ObjectToStr(dr["id"])));
	...
	templateBuilder.Append(linkurl("content_list",Utils.ObjectToStr(drr["id"])));
	...
	templateBuilder.Append("\r\n                            </ul>\r\n                        </div>\r\n                    </div>\r\n                    ");
	DataTable contentList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "content_list", category_id, "__id__");
	...
	templateBuilder.Append("\r\n                    <div class=\"right\">\r\n                        ");
	if (contentList.Rows.Count>0)
	{

	templateBuilder.Append("\r\n                        <div class=\"r_top\">\r\n                            <div class=\"r_t_left\">");
	templateBuilder.Append(contentList.Rows[0]["title"].ToString());

	templateBuilder.Append("</div>\r\n                        </div>\r\n                        <div class=\"clear\"></div>\r\n                        <div class=\"entry\">\r\n                            ");
	templateBuilder.Append(contentList.Rows[0]["content"].ToString());
	...
	templateBuilder.Append(linkurl("content_show",Utils.ObjectToStr(dr["id"])));
