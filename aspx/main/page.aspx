...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("\r\n                        </div> -->\r\n                        <div class=\"l_bottom\">\r\n                            <ul class=\"ul_f\">\r\n                                ");
	DataTable cnews = get_article_list(channel, 0, 0, "status=0");

	foreach(DataRow dr in cnews.Rows)
	{

	templateBuilder.Append("\r\n                                <li class=\"");
	if (Utils.StrToInt(Utils.ObjectToStr(dr["id"]), 0)==model.id)
	{
	...
	templateBuilder.Append("\">\r\n                                    <p class=\"p_f\">\r\n                                        <a href='");
	templateBuilder.Append(linkurl("page",Utils.ObjectToStr(dr["call_index"])));
